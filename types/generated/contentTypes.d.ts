...
export interface ApiFormFieldFormField extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['shortText', 'longText', 'email', 'date', 'radio', 'checkbox', 'file']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFormResponseFormResponse
  extends Struct.CollectionTypeSchema {
...
export interface ApiFormForm extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    form_fields: Schema.Attribute.Relation<
      ...
      'api::form-field.form-field'
    >;
    form_responses: Schema.Attribute.Relation<
      'oneToMany',
      'api::form-response.form-response'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    bordered_btn: Schema.Attribute.String;
    bordered_btn_link: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    full_btn: Schema.Attribute.String;
    full_btn_link: Schema.Attribute.String;
    greeting: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hero.hero'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    q1: Schema.Attribute.String;
    q2: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiRoadmapStepRoadmapStep extends Struct.CollectionTypeSchema {
...
export interface ApiRoadmapRoadmap extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    roadmap_steps: Schema.Attribute.Relation<
      'oneToMany',
      'api::roadmap-step.roadmap-step'
    >;
    title: Schema.Attribute.String;
